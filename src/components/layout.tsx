        ...
        <>
            ...
            <header className={styles['header']}>
                <div className={styles['header-row']}>
                    ...
                    <button className={styles['nav-button']} onClick={event => toggleMenu(event)}>Menu</button>
                    <nav className={styles['desktop-nav']}>
                        <ul><Link href='/home'>Home</Link></ul>
                        <ul><Link href='/about'>About</Link></ul>
                        <ul><Link href='/services'>Services</Link></ul>
                        <ul><Link href='/contact'>Contact</Link></ul>
                    </nav>
                </div>
                <nav className={!showMenu ? `${styles['mobile-nav']!} ${styles['hide']!}` : styles['mobile-nav']}>
                    <ul><Link href='/home'>Home</Link></ul>
                    <ul><Link href='/about'>About</Link></ul>
                    <ul><Link href='/services'>Services</Link></ul>
                    <ul><Link href='/contact'>Contact</Link></ul>
